...
def load_db_annotation(base_path, set_name=None):
    ...
    k_path = os.path.join(base_path, set_name, '%s_K.json' % set_name)
    mano_path = os.path.join(base_path, set_name, '%s_mano.json' % set_name)
    xyz_path = os.path.join(base_path, set_name, '%s_xyz.json' % set_name)
