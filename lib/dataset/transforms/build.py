...
def build_transforms(cfg, is_train=True):
    ...
    if is_train and cfg.WITH_DATA_AUG:
        ...
        output_size = cfg.MODEL.HEATMAP_SIZE[0]
    ...
    # elif 'FHA' in cfg.DATASET.DATASET:
    #     dataset_name = 'FHA'
    # elif 'MHP' in cfg.DATASET.DATASET or 'MHP_seq' in cfg.DATASET.DATASET:
    #     dataset_name = 'MHP'
    # else:
    #     raise ValueError('Please implement flip_index for new dataset: %s.' % cfg.DATASET.DATASET)
    
    flip_index = FLIP_CONFIG['RHD']
    ...
    transforms = T.Compose(
        [
            ...
            T.ToTensor(),
            T.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]) # R G B
        ]
    )
#
    return transforms
