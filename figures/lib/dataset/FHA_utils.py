...
if __name__ == '__main__':
    ...
    parser.add_argument('--subject', required=False, default='Subject_1')
    parser.add_argument('--action_name', required=False, default='close_peanut_butter')
    parser.add_argument('--seq_idx', required=False, default='1')
    parser.add_argument('--frame_idx', required=False, default=-1, type=int)
    parser.add_argument(
    ...
    if args.frame_idx == -1:
        for i in range(len(os.listdir(os.path.join(args.root, 'Videos',  args.subject,
                                args.action_name, args.seq_idx, 'color')))):
            sample = {
            ...
            img_path = os.path.join(args.root, 'Videos', sample['subject'],
